 ...
 */
class ContinuousElicitationForm extends BaseContinuousElicitationForm {
    ...
    public function configure() {
        ...
        //$this->widgetSchema->moveField('median', sfWidgetFormSchema::AFTER, 'upper');
    }
