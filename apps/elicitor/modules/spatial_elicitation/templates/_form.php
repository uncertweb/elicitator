...
<?php use_javascript('spatial-elicitation.js'); ?>
...
<div class="grid_11">
    <div class="box rounded shadow">
        <h1>Spatial variable elicitation</h1>
        <div class="grid_6 alpha">
            ...
            <div id="elicitation" class="hidden">
                <form id="form_spatial_elicitation" action="<?php echo url_for('spatial_elicitation/' . ($form->getObject()->isNew() ? 'create' : 'update') . (!$form->getObject()->isNew() ? '?id=' . $form->getObject()->getId() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
                    <input type="hidden" name="sf_data_load" value="<?php echo url_for('@spatial_elicitation_fit_pdf') ?>" />
        ...
        <div class="grid_10">
            <h2 class="blue"><span id="results_title" class="hidden">Results</span> <span class="hidden" id="loader"><img src="/images/ajax-loader.gif" /></span></h2>
            ...
            <input id="form_spatial_elicitation_submit" class="large green button" type="submit" value="Save progress" />
            </form>
        </div>
        <div class="clear"></div>
        <!-- Briefing document -->
